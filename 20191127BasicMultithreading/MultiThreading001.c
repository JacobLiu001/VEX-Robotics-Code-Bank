/* MultiThreading.c
 * This enables joystick & button control of the CLAWBOT's chassis, claw and arm.
 * Controls: Channel 3&4 for chassis movement, Btn5U&D for arm, Btn6U&D for claw.
 * Author: JacobLiu001
 * Date: 27 Nov. 2019
 */
...
task btnC() {
	while (true) {
		int x1 = vexRT[Btn5U] - vexRT[Btn5D];
		int x2 = vexRT[Btn6U] - vexRT[Btn6D];
		motor[armMotor] = x1 * 63;
		motor[clawMotor] = x2 * 63;
	}
}
